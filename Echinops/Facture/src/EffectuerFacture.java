...
public class EffectuerFacture extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					EffectuerFacture frame = new EffectuerFacture(JDOM1.getClientsFromXML(), null);
	 ...
	 * Create the frame.
	 */
	public EffectuerFacture(ArrayList<Client> clientList, JFrame frame) {
		parent = frame;
		...
		separator.setBounds(10, 34, 414, 2);
		contentPane.add(separator);

		JButton btnSlectionner = new JButton("Effectuer une facture");
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if (tab.length != 1)
					...
					if (window instanceof JFrame) {
						...
						Facture fact = new Facture(cli,frame);
					}
				}
			}
		});
